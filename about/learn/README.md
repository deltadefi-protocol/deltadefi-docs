...
* [**Architecture**](architecture/) — How DeltaDeFi works under the hood: accounts, the App Vault, Hydra integration, intent-based processing, and the order book.
* [**Trade**](trade/) — Spot trading mechanics, performance specs, and supported order types.
* [**Whitepaper**](whitepaper.md) — The full technical whitepaper.

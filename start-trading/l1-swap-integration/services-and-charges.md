...
The charges are reflected in [GET /swapIntent/depth](api-market-depth.md#get-swapintent-depth-symbol), so when you see the market depth from the API the fee is already taken into account.

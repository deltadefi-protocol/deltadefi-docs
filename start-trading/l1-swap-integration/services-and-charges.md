...
1. The current order book depth can absorb the swap (use [#get-market-depth](apis.md#get-market-depth "mention") to check whether the book depth would fill the order)
